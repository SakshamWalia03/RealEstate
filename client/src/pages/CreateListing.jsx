...
export default function CreateListing() {
  ...
  return (
    ...
    <main className="p-3 max-w-4xl mx-auto">
      <h1 className="text-3xl font-semibold text-center my-7 text-yellow-100 drop-shadow-xl" style={{fontFamily:"Permanent Marker"}}>
        Create a Listing
      </h1>
      <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-4">
        ...
        <div className="flex flex-col flex-1 gap-4">
          ...
          <button
            ...
            className="p-3 bg-slate-100 text-black font-bold rounded-lg uppercase hover:opacity-95 disabled:opacity-80"
          >
